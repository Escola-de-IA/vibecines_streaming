    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-background/80 backdrop-blur-sm" onClick={onClose}>
      ...
      >
        ...
        <p className="text-muted-foreground text-sm mb-6">
          A lista padrao vem de `public/playlist.zip`. Use esta importacao apenas para testar no navegador atual.
        </p>

        <form onSubmit={handleSubmit} className="space-y-4">
          {!isPrimaryOwner && (
            <p className="text-sm text-destructive">Somente o dono principal pode atualizar a lista.</p>
          )}
          ...
          {mode === 'url' ? (
            ...
            <div>
              <input
                ...
                disabled={!isPrimaryOwner || isLoading}
              />
          ...
          <div className="flex gap-3 justify-end">
            ...
            <button
              type="submit"
              disabled={isLoading || !isPrimaryOwner || mode !== 'url'}
